...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument('--use_pretrained', default=None, type=none_or_str) # 'none', 'gpt-2' or a path to the pretraind model
    ...
    parser.add_argument('--results_path', default=None, type=str, required=False)
    ...
    args = parser.parse_args(remaining, namespace)
    ...
    if args.exp_name is None:
        special_name_handle_fields = {"model", "lr", "batch_size", 
                                      ...
                                      "wandb", "wandb_project", "wandb_group","eval_seq_prefix", 
